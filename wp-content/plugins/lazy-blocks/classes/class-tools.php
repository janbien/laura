...
class LazyBlocks_Tools {
    ...
    public function render_tools_page() {
        ...
        ?>
        <div class="wrap">
            <h1 class="wp-heading-inline"><?php echo esc_html__( 'Tools', 'lazy-blocks' ); ?></h1>

            <div id="poststuff">
                <div id="lazyblocks_tools" class="postbox">
                    <button type="button" class="handlediv" aria-expanded="true"><span class="screen-reader-text"><?php echo esc_html__( 'Toggle panel: Export', 'lazy-blocks' ); ?></span><span class="toggle-indicator" aria-hidden="true"></span></button><h2 class="hndle ui-sortable-handle"><span><?php echo esc_html__( 'Export', 'lazy-blocks' ); ?></span></h2>
                    <div class="inside">
                        <p><?php echo esc_html__( 'You can export PHP code and use it in the theme/plugin to register a local version of generated blocks and templates. A local field group can provide many benefits such as faster load times, version control & dynamic blocks/templates. Simply copy and paste the following code to your theme\'s functions.php file or include it within an external file.', 'lazy-blocks' ); ?></p>
