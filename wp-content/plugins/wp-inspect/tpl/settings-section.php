<?php !defined('ABSPATH') && exit; ?>
        <fieldset id="<?php $this->field_id($section, true) ?>">
            ...
            <table class="form-table">
                ...
                <tr>
                    ...
                    <td>
                        <ul>
                            <li><input type="checkbox" name="<?php $this->field_name(sprintf('%s_ctx_header', $section)) ?>" id="<?php $this->field_id(sprintf('%s-ctx-header', $section)) ?>" value="<?php echo WPI_CONTEXT_HEADER ?>" <?php checked($this->get_setting(sprintf('%s_ctx_header', $section)), WPI_CONTEXT_HEADER) ?> /><label for="<?php $this->field_id(sprintf('%s-ctx-header', $section)) ?>">Header</li>                            
                            <li><input type="checkbox" name="<?php $this->field_name(sprintf('%s_ctx_middle', $section)) ?>" id="<?php $this->field_id(sprintf('%s-ctx-middle', $section)) ?>" value="<?php echo WPI_CONTEXT_MIDDLE ?>" <?php checked($this->get_setting(sprintf('%s_ctx_middle', $section)), WPI_CONTEXT_MIDDLE) ?> /><label for="<?php $this->field_id(sprintf('%s-ctx-middle', $section)) ?>">Middle</li>
                            <li><input type="checkbox" name="<?php $this->field_name(sprintf('%s_ctx_footer', $section)) ?>" id="<?php $this->field_id(sprintf('%s-ctx-footer', $section)) ?>" value="<?php echo WPI_CONTEXT_FOOTER ?>" <?php checked($this->get_setting(sprintf('%s_ctx_footer', $section)), WPI_CONTEXT_FOOTER) ?> /><label for="<?php $this->field_id(sprintf('%s-ctx-footer', $section)) ?>">Footer</li>                            
                            <li><input type="checkbox" name="<?php $this->field_name(sprintf('%s_ctx_hidden', $section)) ?>" id="<?php $this->field_id(sprintf('%s-ctx-hidden', $section)) ?>" value="<?php echo WPI_CONTEXT_HIDDEN ?>" <?php checked($this->get_setting(sprintf('%s_ctx_hidden', $section)), WPI_CONTEXT_HIDDEN) ?> /><label for="<?php $this->field_id(sprintf('%s-ctx-hidden', $section)) ?>">Hidden (Off-Canvas)</li>                            
                        </ul>
                    </td>
                </tr>                
                <tr>
